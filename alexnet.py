...
exception_module_names = ['Aux']

# Now, convert!
pytorch2timeloop.convert_model(model=net,input_size=input_shape,batch_size=batch_size,model_name=model_name,save_dir=top_dir, fuse=True, convert_fc=convert_fc,ignored_func=None,exception_module_names=exception_module_names)